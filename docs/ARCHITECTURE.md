...
max (verified floor for 2.37.x — 512 MB OOMs at boot). The exporter is capped at
64 MB. Standalone application resource budgets are owned by their deployments.
